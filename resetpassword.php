                        ...
                        <div class="card-body py-5 px-md-5">
                            <form action="" method="post" id="ResetForm" enctype="multipart/form-data">
                                    ...
                                    if (empty($reuserid) || empty($currentpassword) || empty($newpassword)) {
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            if (password_verify($currentpassword, $hashedpassword)) {
                                                ...
                                                $updateStmt->bind_param("ss", $newHashedPassword, $reuserid);
                                                $updateStmt->execute();
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <label class="form-label" for="foremail">User Name</label>
                                </div>
